...
function peddlers30a_assets() {
	...
	wp_enqueue_style( 'peddlers30a-sections', $dir . '/assets/css/sections.css', array( 'peddlers30a-components' ), '212' );
	...
	wp_enqueue_script( 'peddlers30a-main', $dir . '/assets/js/main.js', array(), '75', true );
}
